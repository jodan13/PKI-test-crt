...
import { Any, compareSchema, Sequence } from "./asn1";
...
export default class TimeStampResp
{
	...
	static compareWithDefault(memberName, memberValue)
	{
		...
		{
			case "status":
				return ((PKIStatusInfo.compareWithDefault("status", memberValue.status)) && !("statusStrings" in memberValue) && !("failInfo" in memberValue));
			case "timeStampToken":
