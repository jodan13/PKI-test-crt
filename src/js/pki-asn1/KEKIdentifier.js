...
import { compareSchema, GeneralizedTime, OctetString, Sequence } from "./asn1";
...
export default class KEKIdentifier
{
	...
	static compareWithDefault(memberName, memberValue)
	{
		switch(memberName)
		{
			...
			case "other":
				return (memberValue.compareWithDefault("keyAttrId", memberValue.keyAttrId)) && !("keyAttr" in memberValue);
			default:
				throw new Error(`Invalid member name for KEKIdentifier class: ${memberName}`);
		}
	}
