...
import { arrayBufferToString, bufferToHexCodes, fromBase64, getParametersValue, stringToArrayBuffer, toBase64, utilFromBase, utilToBase } from "pvutils";

import { Any, fromBER, OctetString, RawData } from "./asn1";
import { getCrypto, getEngine } from "./common";
...
export async function verifySCTsForCertificate(certificate, issuerCertificate, logs, index = (-1))
{
	...
	for(let i = 0; i < certificate.extensions.length; i += 1)
	{
