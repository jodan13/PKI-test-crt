...
import { compareSchema, fromBER, OctetString, Repeated, Sequence } from "./asn1";
				...
				case "1.2.840.113549.1.7.3":
					{
						...
						const {recipientCertificate} = parameters.safeContents[index];
						...
						const {recipientKey} = parameters.safeContents[index];
						// endregion
				...
				case "1.2.840.113549.1.7.6":
					{
						...
						const {password} = parameters.safeContents[index];
						// endregion
				...
				case 2:
					{
						...
						const {encryptionAlgorithm} = parameters.safeContents[index];
						// endregion
