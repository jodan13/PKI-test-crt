...
import { compareSchema, Integer, OctetString, Sequence } from "./asn1";
...
export default class KEKRecipientInfo
{
	...
	static compareWithDefault(memberName, memberValue)
	{
		switch(memberName)
		{
			...
			case "kekid":
				return (memberValue.compareWithDefault("keyIdentifier", memberValue.keyIdentifier)) && !("date" in memberValue) && !("other" in memberValue);
			case "keyEncryptionAlgorithm":
				return (memberValue.algorithmId === "") && !("algorithmParams" in memberValue);
			case "encryptedKey":
