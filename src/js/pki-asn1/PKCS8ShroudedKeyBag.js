...
import { Choice, compareSchema, fromBER, OctetString, Sequence } from "./asn1";
...
export default class PKCS8ShroudedKeyBag
{
	...
	static compareWithDefault(memberName, memberValue)
	{
		...
		{
			case "encryptionAlgorithm":
				return ((AlgorithmIdentifier.compareWithDefault("algorithmId", memberValue.algorithmId)) && !("algorithmParams" in memberValue));
			case "encryptedData":
