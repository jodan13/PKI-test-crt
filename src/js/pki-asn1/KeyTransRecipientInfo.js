...
import { compareSchema, Integer, OctetString, Primitive, Sequence } from "./asn1";
...
export default class KeyTransRecipientInfo
{
	...
	fromSchema(schema)
	{
		...
		if(asn1.result.rid.idBlock.tagClass === 3)
			{this.rid = new OctetString({ valueHex: asn1.result.rid.valueBlock.valueHex });} // SubjectKeyIdentifier
		else
