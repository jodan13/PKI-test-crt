...
import { compareSchema, fromBER, Integer, ObjectIdentifier, OctetString, Sequence, UTCTime } from "./asn1";
import Attribute from "./Attribute";
import AuthenticatedSafe from "./AuthenticatedSafe";
import { getAlgorithmByOID, getCrypto, getEngine, getOIDByAlgorithm, getRandomValues } from "./common";
			...
			case "1.2.840.113549.1.7.2":
				{
					...
					{
						for(let i = 0; i < cmsSigned.encapContentInfo.eContent.valueBlock.value.length; i += 1)
